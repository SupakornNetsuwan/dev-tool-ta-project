...
import type { ResponseGetEnrollType } from "@/app/api/enroll/[subjectId]/EnrollType"
const TableStudents: React.FC<{studentsEnroll:ResponseGetEnrollType  }> = ({studentsEnroll}) => {
    return(
        <>
         <DataGrid
