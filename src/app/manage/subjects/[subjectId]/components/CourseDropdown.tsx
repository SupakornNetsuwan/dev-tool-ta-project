    ...
    deleteCourse.mutate(
      ...
      },
      {
        onSuccess(data, variables, context) {
          ...
          router.replace("/manage/subjects");
        },
      ...
      description: (
        <div className="text-gray-500">
          ...
          <ul className="list-inside list-disc">
            <li>คุณจะไม่สามารถย้อนกลับได้</li>
            <li>ข้อมูลจะหายไปถาวร</li>
          </ul>
        </div>
      ),
      cancelButton: <button className="btn bg-gray-50 px-4 py-2 text-gray-500">ยกเลิก</button>,
      actionButton: (
        <button onClick={deleteCourseHandler} className="btn bg-red-50 px-4 py-2 text-red-500">
          ยืนยัน
        </button>
      ),
    });
