  ...
  return (
    <AlertDialog.Root open={showDialog} onOpenChange={setShowDialog}>
      ...
      <AlertDialog.Portal>
        ...
        />
        <AlertDialog.Content className="fixed left-1/2 top-1/2 z-50 max-h-[85vh] w-[90vw] max-w-[500px] origin-top-left rounded-[6px] bg-white p-[25px] shadow-[hsl(206_22%_7%_/_35%)_0px_10px_38px_-10px,_hsl(206_22%_7%_/_20%)_0px_10px_20px_-15px] focus:outline-none data-[state=open]:animate-openDialog">
